...
echo gdm3 xorg gnome-core gnome-control-center gnome-tweaks nvidia-driver mesa-utils efibootmgr grub-efi vlc ark xpdf iceweasel kate htop plasma-nm mtools nano task-german task-german-desktop >> config/package-lists/desktop.list.chroot
