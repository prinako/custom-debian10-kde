...
echo sddm xorg kde-plasma-desktop nvidia-driver vlc ark xpdf iceweasel kate htop plasma-nm mtools nano task-german task-german-desktop >> config/package-lists/desktop.list.chroot
